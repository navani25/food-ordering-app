...
How to Use
1.
Select Hotel Type: Choose between Vegetarian (1) or Non-Vegetarian (2) hotels
2.
Choose Hotel: Select from 5 available hotels in your chosen category
3.
Select Food Items: Browse the menu and select your desired dishes
4.
Specify Quantity: Enter the quantity for each item
5.
Continue or Checkout: Choose to add more items (0) or proceed to billing (1)
6.
View Total: Your final bill amount will be displayed
🍴 Menu Overview
Vegetarian Hotels
1. Hotel Madhuras
...
Common Issues
1.
Compilation Error: Ensure GCC is properly installed and added to PATH
2.
Permission Denied: On Linux/macOS, ensure the executable has proper permissions:
bash
chmod +x food_app
3.
Input Not Working: Make sure to enter valid numerical choices as prompted
